...
public abstract class Section {
	...
	public int wavefront;//estimated status transition location
	public int _wavefront;//true status transition location
