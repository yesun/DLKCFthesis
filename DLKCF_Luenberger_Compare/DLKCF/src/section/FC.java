...
public class FC extends Section {	
	...
	static double[] paramDefault = {1.0, 0.225, 1.0};//*model parameters used for traffic estimation	
	...
	//In FC mode (unobservable), the location of the shock is determined by the estimates
