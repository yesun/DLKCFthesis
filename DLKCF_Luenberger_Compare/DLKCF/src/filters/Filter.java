...
public abstract class Filter {
	...
	public DoubleMatrix var;//estimation error covariance matrix
	public DoubleMatrix mean;//estimate
	public DoubleMatrix f_var;//prior estimation error covaiance matrix
	public DoubleMatrix f_mean;//prior estimate
	
	public double gamma;//scaling factor in consensus term
	public DoubleMatrix Kgain;//Kalman gain
	
	public DoubleMatrix measurements;//sensor data
